...
% Descripción: Predicado que verifica si existe una coordenada (X,Y) en
...
% Tipo: Otras funciones
% Tipo de recursión: Cola, da resultado inmediato
...
flipV_formato([CabezaC | ColaC], [Cabeza | Cola], CoordX_final, CoordX, CoordY, CoordY_final, [NuevaCabeza | Cola2]):-
    existeCoordXY([CabezaC | ColaC], CoordX, CoordY) ->
        R is CoordX_final-CoordX,
        R1 is CoordY+1,
        cambiarCoordXY(Cabeza, CoordY, R, NuevaCabeza),
        flipV_formato([CabezaC | ColaC], Cola, CoordX_final, CoordX, R1, CoordY_final, Cola2)
        ;
        (CoordY > CoordY_final) ->
            R2 is CoordX+1,
            flipV_formato([CabezaC | ColaC], [Cabeza | Cola], CoordX_final, R2, 0, CoordY_final, Cola2)
            ;
            R3 is CoordY+1,
            flipV_formato([CabezaC | ColaC], [Cabeza | Cola], CoordX_final, CoordX, R3, CoordY_final, Cola2).
